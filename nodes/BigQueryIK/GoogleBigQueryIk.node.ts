...
export class GoogleBigQueryIk implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Google BigQuery IK',
		name: 'googleBigQueryIk',
		icon: 'file:googleBigQuery.svg',
		group: ['input'],
		version: 1,
		subtitle: '={{$parameter["operation"] + ": " + $parameter["resource"]}}',
		description: 'Consume Google BigQuery API (added support for query operation)',
		defaults: {
			name: 'Google BigQuery IK',
		},
		inputs: ['main'],
		outputs: ['main'],
		credentials: [
